...
|---|---------|--------|----------------|----------------------|
| **CREATE** |
| 1 | AI Legal Document Generator | **NOT IMPLEMENTED** | — | Build document-type selection UI; Gemini (or templated) generation workflow; store generated drafts in DB/storage; new routes (e.g. `/dashboard/create`); prompts for NDAs, employment, lease, etc.; export/download generated doc |
